...
namespace ExampleApp
{
    namespace
    {
        ...
        {
            const Eegeo::v4 bgColor = Eegeo::v4(0.0f/255.0f, 125.0f/255.f, 165.0f/255.f, 1.0f);
            ...
            loadingScreenConfig.loadingBarColor = Eegeo::v4(255.0f/255.0f, 255.0f/255.0f, 255.0f/255.0f, 1.0f);
