    ...
    namespace DirectionsMenu
    {
        namespace View
        {
            ...
            public:
                ...
                virtual void SetStartLocationSuggestions(const std::vector<Search::SdkModel::SearchResultModel>& results, bool geoName) = 0;
                
                virtual void SetEndLocationSuggestions(const std::vector<Search::SdkModel::SearchResultModel>& results, bool geoName) = 0;
