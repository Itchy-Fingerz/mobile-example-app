...
namespace ExampleApp
{
    namespace PointingQuadRadialLine
    {
        ...
        QuadLineRenderable::QuadLineRenderable(Eegeo::Rendering::LayerIds::Values layerId,
        ...
        void QuadLineRenderable::OnMaterialChanged(const Eegeo::Rendering::Materials::IMaterial* pMaterial, Eegeo::Rendering::VertexLayouts::VertexBindingPool& vertexBindingPool)
        {
        ...
        void QuadLineRenderable::Render(Eegeo::Rendering::GLState& glState) const
        {
        ...
        Eegeo::m44 QuadLineRenderable::CalcModelViewProjection(const Eegeo::dv3& ecefCameraPosition, const Eegeo::m44& viewProjection, const float environmentFlatteningScale) const
        {
