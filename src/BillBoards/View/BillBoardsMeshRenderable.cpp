...
namespace ExampleApp
{
    namespace BillBoards
    {
        namespace View
        {
            BillBoardsMeshRenderable::BillBoardsMeshRenderable(Eegeo::Rendering::LayerIds::Values layerId,
            ...
            BillBoardsMeshRenderable::~BillBoardsMeshRenderable()
            {
                printf("");
                delete &m_mesh;
                delete m_material;
            ...
            void BillBoardsMeshRenderable::OnMaterialChanged(const Eegeo::Rendering::Materials::IMaterial* pMaterial, Eegeo::Rendering::VertexLayouts::VertexBindingPool& vertexBindingPool)
            {
            ...
            void BillBoardsMeshRenderable::Render(Eegeo::Rendering::GLState& glState) const
            {
            ...
            Eegeo::m44 BillBoardsMeshRenderable::CalcModelViewProjection(const Eegeo::dv3& ecefCameraPosition, const Eegeo::m44& viewProjection, const float environmentFlatteningScale) const
            {
            ...
            Eegeo::v3 BillBoardsMeshRenderable::GetForwardVector()
            {
                return m_orientationEcef.GetRow(0);
            }
        }
    }
}
