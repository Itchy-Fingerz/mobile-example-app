...
namespace ExampleApp
{
    namespace BillBoards
    {
        namespace View
        {
            class BillBoardsMeshRenderable : public Eegeo::Rendering::RenderableBase
            {
            public:
                BillBoardsMeshRenderable(Eegeo::Rendering::LayerIds::Values layerId,
                ...
                void SetConfig(const BillBoardConfig& config){ m_config = config;}
                const BillBoardConfig& GetConfig(){ return m_config;}
