...
namespace ExampleApp
{
    namespace Materials
    {
        ...
        namespace Materials
        {
            class DepthOnlyMaterial : public Eegeo::Rendering::Materials::IMaterial, protected Eegeo::NonCopyable
            {
            public:
                DepthOnlyMaterial(const Eegeo::Rendering::TMaterialId materialId,
