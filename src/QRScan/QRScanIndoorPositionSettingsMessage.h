...
namespace ExampleApp
{
    namespace QRScan
    {
        class QRScanIndoorPositionSettingsMessage
        {
            std::string m_apiKey;
        ...
        public:
            QRScanIndoorPositionSettingsMessage(std::string apiKey, std::string apiSecret, std::map<int, std::string> floorMap, std::string interiorId);
