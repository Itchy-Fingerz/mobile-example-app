...
@implementation OptionsSignOutSubView
...
- (id)init
{
    ...
    if(self)
    {
        ...
        self.pHeaderView = [[[HeaderView alloc] initWithWidth:200 title:@"Sign out"] autorelease];
...
{
    self.pMessageContent.text = @"Signed out successfully";
