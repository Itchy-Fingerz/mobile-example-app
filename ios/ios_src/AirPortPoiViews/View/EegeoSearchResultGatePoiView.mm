...
-(void) FlightListFromSearchResult
{
    ...
    ExampleApp::Search::SdkModel::FlightResultModel flightModel("American","AA 395","Paris","130","11:54","12:34");
    m_flightsVector.push_back(flightModel);
    
    
    m_flightsVector.push_back(ExampleApp::Search::SdkModel::FlightResultModel("American","AA 396","Chicago","131","12:04","12:34"));
    
    m_flightsVector.push_back(ExampleApp::Search::SdkModel::FlightResultModel("American","AA 397","Amsterdam","132","12:14","12:34"));
    ...
    m_flightsVector.push_back(ExampleApp::Search::SdkModel::FlightResultModel("American","AA 401","San Salvidor","136","12:54","12:34"));

    m_flightsVector.push_back(ExampleApp::Search::SdkModel::FlightResultModel("American","AA 402","Guatemala Cty","137","13:04","12:34"));

    m_flightsVector.push_back(ExampleApp::Search::SdkModel::FlightResultModel("American","AA 403","Beijing","138","13:14","12:34"));

    m_flightsVector.push_back(ExampleApp::Search::SdkModel::FlightResultModel("American","AA 404","Hong Kong","139","13:24","12:34"));
