#!/bin/sh
librarypath=$(pwd)/eegeo-stream-app-ios/
tuneup_js_tests=$(pwd)/tests/EndToEnd/iOS/testsuite.js
targetName=Eegeo_Streaming
productName="Stream Alpha"
productVersion=i386
logfilename="testoutput.log"
simulatorType="iPad 2 (7.1 Simulator)"
